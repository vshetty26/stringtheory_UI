        ...
        <footer className="footer">
            <div className="footer-container">
                <div className="footer-content">
                    <div className="footer-column">
                        ...
                        <div className="social-links">
                            ...
                            <a href="https://www.instagram.com/deeceeaccessories?igsh=MWQ1c2hoeTI5dmdraA%3D%3D" className="social-link" target="_blank" rel="noopener noreferrer">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="footer-column">
                        ...
                        <ul className="contact-details">
                            ...
                            <li>
                                ...
                                thestringtheory.cs@gmail.com
                            </li>
                            <li>
                                <strong>Address:</strong> <br />
                                X-45, Pratap Gali, Gandhi Nagar, Delhi, 110031
                            </li>
                        </ul>
                    </div>
                ...
                <div className="footer-bottom">
                    <p>&copy; 2024 The String Theory. All rights reserved.</p>
